...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div([html.H2('Select Launch Site:', style={'margin-right': '2em'}),
                                dcc.Dropdown(id='site-dropdown',
                                             options = [{'label': 'All Sites', 'value': 'ALL'},
                                                        {'label': 'Cape Canaveral LC40', 'value': 'CCAFS LC-40'},
                                                        {'label': 'Cape Canveral SLC40', 'value': 'CCAFS SLC-40'},
...
def get_scatter_plot(entered_site,payload):
    ...
    df = spacex_df[(spacex_df['Payload Mass (kg)']<=max_payload) & (spacex_df['Payload Mass (kg)']>=min_payload)]
